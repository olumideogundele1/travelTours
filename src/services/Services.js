          ...
          <div className="row ml-minus-15 mr-minus-15 services__content__container">
            <div className="col-6 p-15">
              <div className="services__left">
                <h1 className="services__left__heading animation">{state.heading}</h1>
                <p className="services__left__paragraph animation">
                  Our aim is to provide professional and unique services to customers, and we have provided high quality
                  services to our customers thats why they love travel and friends!!!
                </p>
              </div>
            </div>
            <div className="col-6 p-15">

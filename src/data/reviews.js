const reviews = [
  {
    id: 1,
    name: "ali",
    comment: "That's great travel agency so far I see with great team and user friendly",
    stars: 4,
  ...
  },
  {
    id: 2,
    name: "alex",
    comment: "I suggest travel friends to everyone because I love travel friends",
    stars: 5,
  ...
  },
  {
    id: 6,
    name: "shakil khan",
    comment: "I love the facilities especially when I reached to USA, travel friend's car was present there for me.",
    stars: 2,
  ...
  },
  {
    id: 8,
    name: "alex jobs",
    comment: "I did travel with some other agencies as well but travel friends is more professional than others.",
    stars: 5,
